...
exports.InternalAdapter = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../prisma/prisma.service");
let InternalAdapter = class InternalAdapter {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async deploy(input) {
        ...
        if (!site)
            return { log: 'No site to deploy', version: '0' };
...
exports.InternalAdapter = InternalAdapter;
exports.InternalAdapter = InternalAdapter = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], InternalAdapter);
//# sourceMappingURL=internal.adapter.js.map